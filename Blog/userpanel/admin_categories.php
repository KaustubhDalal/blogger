...
?>
  ...
  $mysql1 = "SELECT allow_insert FROM member_permissions where options='Categories' and mem_id=$userid";
  $mysql2 = "SELECT allow_view FROM member_permissions where options='Categories' and mem_id=$userid";
  $mysql3 = "SELECT allow_edit FROM member_permissions where options='Categories' and mem_id=$userid";
  $mysql4 = "SELECT allow_delete FROM member_permissions where options='Categories' and mem_id=$userid";
...
?>
 <table class="table table-bordered <?php echo $display2;?>" >
  <thead>
    <tr>
         <th scope="col"></th>
      <th scope="col">Id</th>
      ...
      <th scope="col" class="<?php echo $display4;?>">Delete Category</th>
      <th></th>
        <th scope="col" class="<?php echo $display3;?>">Update Category</th>
...
<?php 
  ...
  $resultcat1 = mysqli_query($conn, $sqlcat1);
    ...
    <tr>
        <form action="" method="post" name="userdelete">
            <td>
            <input type="checkbox" name="keyToDelete" value="<?php echo $rowcat1["cid"];?>">
        </td>
      <th scope="row"><?php echo $rowcat1["cid"];?></th>
      <td><?php echo $rowcat1["CName"];?></td>
