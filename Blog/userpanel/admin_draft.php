 ...
 <table class="table table-bordered">
  <thead>
    <tr>
      ...
      <th scope="col">Remove blog</th>
      <th scope="col">Update blog</th>
    </tr>
  </thead>
  <tbody>
<?php 
  ...
  include_once '../conn.php';
  $sql = "SELECT * FROM blog_records where bstatus='Draft' and userid=$userid ";
    ...
    <tr>
      ...
      <td><?php echo '<img src="../blog_images/'.$row['bimage'].'" height="30" width="30" />';?></td>
       ...
       <td>
        ...
        <td>
            <input type="submit" value="Update"name="submitupdatebtn" class="btn btn-info">
        </td>
    </tr>
     <?php
            }
         } else {
            echo "No any blogs in your draft";
         }
         mysqli_close($conn);
