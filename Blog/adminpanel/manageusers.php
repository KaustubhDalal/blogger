...
<?php 
  ...
  include_once '../conn.php';
  $sql = "SELECT * FROM membership_users where Username<> 'admin'";
    ...
    <tr>
      ...
      <td><?php echo $row["Username"];?></td>
       <td><?php echo $row["Email"];?></td>
        ...
        <td>
           <?php echo "<td> <a class='btn btn-info' href='update_user.php?id=$row[ID]  & user=$row[Username] & email=$row[Email] '>Update</a>";?>  
        </td>
