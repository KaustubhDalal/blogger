                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <h2 class="number"></h2>
                                   <a href="adminblogs.php"> <span class="desc">Blogs</span></a>
                                    <div class="icon">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <h2 class="number"></h2>
                                    <a href="admin_categories.php"><span class="desc">Categories</span></a>
                                    <div class="icon">
                             ...
                             <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <h2 class="number"></h2>
                                    <a href="admin_draft.php"><span class="desc">Draft</span></a>
                                    <div class="icon">
                           ...
                           <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <h2 class="number"></h2>
                                    <a href="admin_editchoice.php"><span class="desc">Editor's choice</span></a>
                                    <div class="icon">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <h2 class="number"></h2>
                                    <a href="manageusers.php"><span class="desc">Manage Users</span></a>
                                    <div class="icon">
                             ...
                             <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <h2 class="number"></h2>
                                    <a href="contactinfo.php"><span class="desc">Contacts</span></a>
                                    <div class="icon">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <h2 class="number"></h2>
                                    <a href="admin_report.php"><span class="desc">Report</span></a>
                                    <div class="icon">
