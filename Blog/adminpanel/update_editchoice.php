    ...
    include_once '../conn.php';
     $sql3 = 'SELECT * FROM blog_records';
         ...
         $result3 = mysqli_query($conn, $sql3);
               ...
               <select class="form-select col-3" aria-label="Default select example" name="editor" id="editor">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Select</th>
       <th scope="col">Remove from editor choice</th>
