...
{  
  ...
  //$file1=addslashes(file_get_contents($_FILES["imagefile"]["tmp_name"]));
     ...
     $user_info_sql = "update membership_users set Username='$user_fname',Email='$user_email',Password='$user_pass', CPassword='$user_cpass',Address='$user_address',City='$user_city' ,Phone='$user_phone' where ID=78";

     if (mysqli_query($conn, $user_info_sql)) 
     {?>
      <div class=" col-5 alert alert-success alert-dismissible" style="margin-left: 14%">
    <button type="button" class="close" data-dismiss="alert">&times;</button>
    <?php echo "your Details updated successfully !";?>
  </div>
                    ...
                    <div class="row gutters">
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="text-right">
                          ...
                          <a href="index2.php"><button  type="button" id="submit" name="submit" class="btn btn-primary">Cancel</button></a> 
