...
$file=addslashes(file_get_contents($_FILES["imagefile"]["tmp_name"]));
   ...
   $sql3 = "INSERT into `blog_categories` (CName,cat_image,uid) 
VALUES ('$cat','$file','$userid')";
...
<form action="" method="post"  name="register_form" onsubmit="return validate()" style="margin-top: 3%; margin-bottom: 3%;" enctype="multipart/form-data">
