    ...
    {    
       ...
       // $id=$_POST['blogid'];
		    //$pass=$_POST['password'];
	  		 ...
	  		 $sql = "update membership_users set Password='$newpass' ,CPassword='$cnewpass' WHERE token='$token' ";
			 //echo $sql;
   ...
   <div class="col-lg-4 " style=" margin-top: 5%;">
                    ...
                    <form action="" method="post"  name="message" data-focus="false" style="border:none !important;">
                        ...
                        <div class="form-group">
                            <input type="password" class="form-control-input" name="newpass" id="newpass" oninput="mypass()" style="margin: 3px 0 !important;" required>
                            <label class="label-control" for="cemail">New Password</label>
                            <div class="help-block with-errors"></div>
                        </div>
                         <p id="letter" style="color: red"></p>
                         <div class="form-group">
                            <input type="password" class="form-control-input" name="cnewpass" id="cnewpass"  oninput="mycpass()" style="margin: 3px 0 !important;" required>
                       ...
                       <?php echo $msg?>
                        ...
                        <div class="form-group">
                            <input type="submit" class="form-control-submit-button" value="Reset"name="submit" onclick="myFunction()">
                        </div>
