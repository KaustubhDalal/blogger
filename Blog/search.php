...
<?php $query = $_GET['search']; ?>
     ...
     <h3 style="margin-left: 3%;margin-top: 3%;">Search Result for"<?php echo $query; ?>"</h3>
<?php
    $min_length = 3;
    ...
    if(strlen($query) >= $min_length){ // if query length is more or equal minimum length then
        ...
        $raw_results = mysqli_query($conn,"SELECT * FROM blog_records
            WHERE (`btitle` LIKE '%".$query."%') OR (`btag` LIKE '%".$query."%') OR (`bcontent` LIKE '%".$query."%')") or die(mysqli_error());
 ...
 <div class="card col-6 mb-3  box ml-5 " style="margin-top: 20px;">
                   <!-- <a href="single.php?post=<?php echo $row1["bid"];?>" class="abc">-->
                  <div class="row no-gutters">
                    <div class="col-lg-4">
                        <td >
                            <?php echo '<img src="blog_images/'.$results['bimage'].'" height="250" width="250" />';?>
                            </td>";
                    ...
                    <div class="col-md-8">
                      <div class="card-body">
                       ...
                       <p class="card-text"><small class="text-muted" style="text-align: left !important;">
                        <?php custom_echo($results["bcontent"], 200); ?>
...
<br><br>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; <?php echo "  Not Fould what you are looking for";
        }
