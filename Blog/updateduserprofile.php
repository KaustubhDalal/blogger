...
<?php 
  ...
  $sql1 = "SELECT * FROM membership_users where Username='$userinfo' ";
            ...
            {?>
              ...
              <div class="container" style="margin-top: 3%">
                  ...
                  <div class="card-body">
                    <div class="account-settings">
                      <div class="user-profile">
                        ...
                        <h5 class="user-name"><?php echo $userinfo ?></h5>
                ...
                <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                  <form action="updateduserprofile.php" method="post"  name="update_profile_form" >
                <div class="card h-100">
                  <div class="card-body">
                    <div class="row gutters">
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="fullname"id="fullName" placeholder="Enter full name" value="<?php echo $userinfo ?>">
                        </div>
                      </div>
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
